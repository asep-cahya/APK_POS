...
class UserController extends Controller
{
    ...
    {
        $dataReq = $request->validated(); // validasi data pada form input

        $user->name = $dataReq['name']; // hasil lolos validasi dari attribute name pada input form
        ...
        $user->save(); // proses simpan ke database pada tabel users
