    ...
    <div class="jenis-container jenis-form-container">
        ...
        <div class="page-header">
            ...
            <p class="page-description">
                Ubah informasi jenis produk yang sudah tersimpan.
            </p>
        </div>
        ...
        <div class="form-card">
            ...
            <div class="form-header">
                ...
                <div>
                    <h5>Edit Informasi Jenis</h5>
                    <p>Perbarui data jenis produk sesuai kebutuhan.</p>
                </div>
            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="textarea-wrapper">
                            ...
                            <textarea
                                ...
                                placeholder="Masukkan keterangan jenis produk...">{{ old('keterangan', $jeni->keterangan) }}</textarea>
                        </div>
